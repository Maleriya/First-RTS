...
public class SoldierAttack : CommandExecutorBase<IAttackCommand>
{
    [SerializeField] private Animator _animator;
    [SerializeField] private SoldierStop _stopCommandExecutor;
    ...
    public class AttackOperation : IAwaitable<AsyncExtensions.Void>
    {
        ...
        private readonly SoldierAttack _attackCommandExecutor;
        private readonly IAttackable _target;

        private bool _isCancelled;

        public AttackOperation(SoldierAttack attackCommandExecutor, IAttackable target)
        {
            _target = target;
